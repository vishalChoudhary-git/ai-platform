...
| Travel Agent example | Agentic AI learning sandbox | Day 11 Plan-and-Execute + checkpointed memory + HITL approval |
...
|---|---|---|---|
| Tool calling | Learned | Expense Agent / Travel Agent | Must know |
| ReAct | Learned | Course exercises | Must know |
| State / nodes / edges | Learned | Travel Agent | Must know |
| Conditional routing / loops | Learned | Travel Agent | Must know |
| Short-term memory / checkpointing | Learned | Travel Agent using `thread_id` | Must know |
| Human-in-the-loop | Learned | Travel Agent approval gate | Must know |
| Middleware | Learned | Course exercise | Should know |
| Plan-and-Execute | Learned | Travel Agent | Must know |
...
| Evaluation | Gap to add | Not implemented in Travel Agent | Must know |
| Observability / tracing | Gap to add | Not implemented in Travel Agent | Must know |
...
## Travel Agent implementation tracker

- [x] Planner node
- [x] Executor node
- [x] Conditional execution loop
- [x] Checkpointed short-term memory
- [x] Human approval before publishing final itinerary
- [ ] Replanner
